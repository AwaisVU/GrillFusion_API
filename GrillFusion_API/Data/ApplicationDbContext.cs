...
// Burgers
new MenuItem { Id = 1, Name = "Classic Smash Burger", Description = "...", Category = "Burger", SpecialTag = "Best Seller", Price = 12.99, Image = "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400" },
new MenuItem { Id = 2, Name = "Double Inferno Burger", Description = "...", Category = "Burger", SpecialTag = "Spicy", Price = 15.99, Image = "https://images.unsplash.com/photo-1553979459-d2229ba7433b?w=400" },
...
// Grills
new MenuItem { Id = 5, Name = "Ribeye Steak", Description = "...", Category = "Grill", SpecialTag = "Chef's Choice", Price = 34.99, Image = "https://images.unsplash.com/photo-1558030006-450675393462?w=400" },
...
new MenuItem { Id = 7, Name = "Grilled Chicken Platter", Description = "...", Category = "Grill", SpecialTag = "", Price = 18.99, Image = "https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?w=400" },
...
new MenuItem { Id = 10, Name = "Onion Rings", Description = "...", Category = "Sides", SpecialTag = "", Price = 5.99, Image = "https://images.unsplash.com/photo-1639024471283-03518883512d?w=400" },
new MenuItem { Id = 11, Name = "Mac & Cheese", Description = "...", Category = "Sides", SpecialTag = "", Price = 6.49, Image = "https://images.unsplash.com/photo-1543339494-b4cd4f7ba686?w=400" },
...
new MenuItem { Id = 15, Name = "Iced Craft Lemonade", Description = "...", Category = "Drinks", SpecialTag = "", Price = 3.99, Image = "https://images.unsplash.com/photo-1523677011781-c91d1bbe2f9e?w=400" }
);
        }
    }
}
